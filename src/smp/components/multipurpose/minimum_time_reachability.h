...
/// Params related to the learned models
#define NFEATURES 14
#define USELEARNING 0
#define NPARAMS 29
/// neural network external functions
...
namespace smp {
    ...
    */
    ...
    public:
        ...
        /**
         * \brief Returns the cost of the trajectory according to the learned neural network.
         *
         *  This function returns the cost of the trajectory that connects the two poses (xin,yin,thin), (xout,yout,thout), 
         *  
         *
         * @returns Returns the cost of trajectory
         */
        double nn_metric(double xin,double yin,double thin,double xout,double yout,double thout);

        /**
         * \brief Returns the cost of the trajectory according to the learned basis function model
         *
         *  This function returns the cost of the trajectory that connects the two poses (xin,yin,thin), (xout,yout,thout), 
         *  
         *
        ...
        double basis_fct_metric(double xin,double yin,double thin,double xout,double yout,double thout);

        /**
         * \brief Sets the type of learned cost model to use
         *
         *  if c==0, use POSQ extender
         *  if c==1, use basis function model
         *  if c==2, use neural network model
         * @returns Returns 1 if successfull
         */
