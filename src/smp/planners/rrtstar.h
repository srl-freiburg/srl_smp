...
x         *
        ...
        int iteration ();
         ...
         /**
         * \brief Returns the nearest vertex in a ball, the nearest in the sense of the choosed metric
         *
        ...
        /**
         * \brief Returns the neighbors of the state_in, according to the BallBoxTheorem
         *
         * @return Returns 1 for success
         */
