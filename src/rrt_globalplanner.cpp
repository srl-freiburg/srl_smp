...
RRT_globalplanner::RRT_globalplanner(const ros::NodeHandle& node) : nh_(node)
{
...
void RRT_globalplanner::setGoal(double x, double y, double theta,double toll){
...
void RRT_globalplanner::publishTree(){
    ...
    tree_marker_.ns = "rrt_globalplanner";
    tree_marker_.id = 1;
    ...
    dedicated_tree_marker_.ns = "rrt_globalplanner";
...
void RRT_globalplanner::callbackSetGoal(const geometry_msgs::PoseStamped::ConstPtr& msg){
...
/// ==================================================================================
bool RRT_globalplanner::initialize(){
    ...
    pub_goal_ = nh_.advertise<visualization_msgs::Marker>("rrt_globalplanner_goal",1000);
    ...
    sub_obstacles_=nh_.subscribe("map",1, &RRT_globalplanner::callbackObstacles,this);    // to read OccupancyGrid and the obstacles' positions
    sub_robot_pose_=nh_.subscribe("slam_out_pose",1,&RRT_globalplanner::callbackSetRobotPose,this); // to read the current robot pose 

    sub_goal_=nh_.subscribe("global_goal",1,&RRT_globalplanner::callbackSetGoal,this);
    
    sub_steer_state_=nh_.subscribe("/steer_robot/end_track",1,&RRT_globalplanner::callbackReadSteerState,this);
...
/// ==================================================================================
void RRT_globalplanner::callbackReadSteerState(const std_msgs::Bool::ConstPtr& msg){
...
void RRT_globalplanner::callbackSetRobotPose(const geometry_msgs::PoseStamped::ConstPtr& msg){
...
/// ==================================================================================
void RRT_globalplanner::callbackObstacles(const nav_msgs::OccupancyGrid::ConstPtr& msg){
...
void RRT_globalplanner::publishPath(Trajectory *t){
...
/// To IMPLEMENT
    ...
    path_marker_.ns = "rrt_globalplanner";
    path_marker_.id = 1;
...
int RRT_globalplanner::readHumanPoses(int hi){
...
/// ==================================================================================
void RRT_globalplanner::saveData(Trajectory *traj, int iter){
...
/// ==================================================================================
void RRT_globalplanner::saveCost(double c,double t){
...
/// =================================================================================
int RRT_globalplanner::saveTree(list <vertex_t *> *list_vertices){
...
int RRT_globalplanner::plan(Trajectory *traj,int type){
...
int main(int argc, char** argv)
{
    ...
    RRT_globalplanner global_planner(node);
